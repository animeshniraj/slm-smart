<?php
    ...
    if(isset($_POST['deleteProcess']))
    {
    	...
    	runQuery("DELETE FROM dispatch_noted WHERE invoiceid='$externalid'");
...
<div class="card-block">
	...
	<tbody>
		...
		<?php
				$result = runQuery("SELECT * FROM dispatch_order WHERE status='UNFULFILLED' ORDER BY entrydate DESC");
