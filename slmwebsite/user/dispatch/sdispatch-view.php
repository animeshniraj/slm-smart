<?php
    ...
    $PAGE = [
        "Page Title" => "View all Sample Dispatch Order | SLM SMART",
        "Home Link"  => "/user/",
        "Menu"		 => "sdispatch-view",
	...
	<div class="row align-items-end">
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					<h3>View all Sample Dispatches</h3>
					<span>Click on Edit button to view or edit Sample Dispatch.</span>
				</div>
			</div>
		</div>
	</div>
...
<div class="col-lg-6">
	<img src="images/sample-dispatch.png">
</div>
...
<table class="table table-striped table-bordered table-xs">
	...
	<tr>
		...
		<td><form method="POST" action="sdispatch-edit.php"><input type="hidden" name="cid" value="<?php echo $row["cid"]; ?>"><button class="btn btn-info" type="submit"><i class="feather icon-edit-2"></i>Edit</button></form></td>
		<?php
...
<form method="POST" id="redirectform" action="sdispatch-edit.php">
