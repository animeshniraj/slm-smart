	...
	<div class="row align-items-end">
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					<h5>View all Sample Dispatches</h5>
...
<div class="card-block">
	...
	<tr>
		...
		<td><form method="POST" action="sdispatch-edit.php"><input type="hidden" name="cid" value="<?php echo $row["cid"]; ?>"><button class="btn btn-primary" type="submit"><i class="feather icon-edit-2"></i>Edit</button></form></td>
		<?php
