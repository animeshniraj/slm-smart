<?php
	...
	if(isset($_POST['getdata']))
	{
		...
		elseif($filter=='grade' && isset($_POST['grade']))
		{
			...
			$result = runQuery("SELECT * FROM loadingadvice_batches WHERE grade='$grade'");
...
<form method="POST">
			...
			<div class="form-group" style="display:flex; justify-content: center;">
				...
				<div class="form-group row">
					...
					<div class="col-sm-12">
					<button type="submit" disabled name ='getdata' id='getdatabtn' class="btn btn-primary btn-block"><i class="feather icon-plus"></i>Get Data</button>
					</div>
				</div>
	</form>
	...
	<form method="POST" action="compareids.php" target="_blank">
		<div class="form-group row">
			...
			<div class="col-md-8" style="display:none;">
				<select onchange="checkcompare();" id="select-compare" required class="js-example-basic-multiple " multiple="multiple" name="compareids[]">
					<?php 
	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><input onclick="transfercheck(this)" type="checkbox" value="<?php echo $value[0] ; ?>"></td>
				<?php 
