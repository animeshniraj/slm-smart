...
<table class="table">
	<tr class="table-top-bottom">
		<th style="text-align:right; border-left: 2px solid black;">Process</th>
		<th>
		...
		<th style="text-align:right; border-left: 2px solid black;">Start Date</th>
		<th>
		...
		<th style="text-align:right; border-left: 2px solid black;">End Date</th>
	...
	<tr class="table-top-bottom">
		<th style="text-align:right; border-left: 2px solid black;">Grade</th>
		<th style="border-right: 2px solid black;" colspan="4">
		...
		<th style="border-right: 2px solid black;;" colspan="1">
