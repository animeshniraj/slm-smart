<?php
    ...
    $PAGE = [
        "Page Title" => "SLM | Final Blend Stock Report",
        "Home Link"  => "/user/",
        "Menu"		 => "process-finalblend-stock",
	...
	<div class="row align-items-end">
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					<h3>Final Blend Stock</h3>
					<span>View Final Blend stock details</span>
				</div>
			</div>
		</div>
	</div>
...
<h5>Select Date Range to see Final Blend report</h5>
<hr>
<div class="row">
...
<tr  style="font-size:14px;">
	...
	<td width="5%"><a target="_blank" href="/user/report/basic-finalblend.php?id=<?php echo $data["id"]; ?>"><?php echo $data["id"]; ?></a></td></td>
