...
<body class="A5 landscape">
  ...
  <table style="width:100%">
    ...
    <tr><td colspan="4" class="bdcen">INSPECTION DONE</td></tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2" style="text-align:right;"><?php echo $finalid;?></td>
    </tr>
    <tr>
      <td style="font-weight:bold;">Approved By</td>
      <td style="height:80px;"></td>
      <td style="font-weight:bold;">Date of Approval</td>
      <td></td>
    </tr>
    <tr>
      <td colspan="2" style="text-align:center;font-weight:bold;font-size:18px;">DISPATCH UPON SLIP CHANGE</td>
      <td colspan="2" style="text-align:center;font-weight:bold;font-size:18px;">NEXT OPERATION -<br> DISPATCH</td>
    </tr>
    <tr>
    </tr>
  </table>
<p style="text-align:right;font-size:12px;font-weight:400;">TAG-07(B)</p>
