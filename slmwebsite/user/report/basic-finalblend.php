        ...
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    ...
                    <span>View Final Blend process report</span>
                </div>
            </div>
        </div>
    </div>
...
<big style="font-weight: bold;">
    ...
    <span>Final Blend ID: <?php echo $data["id"] ?></span>
...
<big style="font-weight: bold;">Batch Usage</big>
<table class="table table-striped table-bordered" >
...
<big style="font-weight: bold;">Semi Finished Usage</big>
<table class="table table-striped table-bordered" >
