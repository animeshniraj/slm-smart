...
<head>
    <meta charset="utf-8">
    <title>SLM SMART - MELTING HEAT REPORT</title>
  ...
  <?php
    ...
    while($row=$result->fetch_assoc())
    {
    	...
    	$result2 = runQuery("SELECT * FROM processentryparams WHERE processid='$currid' AND step='STOCK' AND value<>0");
...
<script type="text/javascript">
    ...
    <div id="ui-view" data-select2-id="ui-view">
        <div>
            <div class="card">
                <div class="card-header">HEAT ID: <?php echo $processid; ?>
...
<big style="font-weight: bold;text-align:center!important;">Generic Property</big>
...
<big style="font-weight: bold;text-align:center;">Operational Property</big>
<table class="table table-striped table-bordered" >
...
<big style="font-weight: bold;text-align:center;">Test Details</big>
<table class="table table-striped table-bordered" >
...
<big style="font-weight: bold;">Raw Material Usage</big>
<table class="table table-striped table-bordered" >
