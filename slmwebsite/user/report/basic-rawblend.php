		...
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					...
					<span>View Raw Blend process report</span>
				</div>
			</div>
		</div>
	</div>
...
<button onclick="window.open('rawblend-detailed.php?id=<?php echo $processid; ?>','_blank').focus();" class="btn waves-effect waves-light btn-primary pull-right"><i class="fa fa-print"></i> Print Report</button>
...
<big style="font-weight: bold;">
	...
	<span>Raw Blend ID: <?php echo $data["id"] ?></span>
