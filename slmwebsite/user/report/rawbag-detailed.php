...
<head>
    <meta charset="utf-8">
    <title>SLM SMART - RAW BAG REPORT</title>
...
<div class="col-lg-12">
	...
	{
?>
<div class="alert alert-info background-danger">This batch was quarantined and allowed by Admin.</div>
<?php
}
else if($isBlocked=="BLOCKED")
	{
?>
<div class="alert alert-danger background-danger">This batch is quarantined.</div>
<?php
}
...
<big style="font-weight: bold;">Raw Blend Usage</big>
<table class="table table-striped table-bordered" >
...
<big style="font-weight: bold;">Heat ID Usage</big>
<table class="table table-striped table-bordered" >
