...
var orgChart = (function() {
   ...
   _rectW          = 250,        /* Width of the rectangle */
...
function loadChilds(actualElement, successFunction) {
   $.getJSON("./trace_func.php?action=trace_forward2&processid=" + actualElement.id, 
          function(data) {
...
$.getJSON("./trace_func.php?action=trace_forward&processid=<?php echo $processid; ?>", 
          function(data) {
             u_data = data;
