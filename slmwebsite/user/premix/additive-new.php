    	...
    	if($result)
    			{
    				...
    				?>
    					<form id="redirectform" method="POST" action="additive-edit.php">
	...
	<div class="row align-items-end">
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					<h5>Add Additive</h5>
					<span>Add new additive stock</span>
				</div>
			</div>
		</div>
	</div>
...
<p style="display:block;text-align:center;color:#212121;">Enter the Date</p>
					...
					<div class="form-group" style="display:flex; justify-content: center">
						<select required class="form-control col-sm-2" name="additive" id="premix_additive">
							<option selected disabled value=""> Choose an additive</option>
					...
					<div class="form-group" style="display:flex; justify-content: center">
						<select required class="form-control col-sm-2" name="supplier" id="premix_supplier">
							<option selected disabled value=""> Choose a supplier</option>

							<?php 

								$result = runQuery("SELECT value,externalid FROM external_param WHERE param='Name' AND externalid IN (SELECT externalid FROM external_conn WHERE type='Supplier')");;
	...
	<div class="form-group row">
		...
		<div class="col-sm-12">
		<button type="button" onclick="checkSupplier()" class="btn btn-primary btn-block"><i class="feather icon-plus"></i>Create New Entry</button>
		</div>
	</div>
