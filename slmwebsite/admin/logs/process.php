...
<div class="card-block">
	<form method="POST" target="_blank" action="/admin/logs/downloadprocesslog.php">
...
<thead>
 <tr role="row">
	...
	<th rowspan="1" colspan="1"  style="width: 356.875px;">Log Time</th>
	<th rowspan="1" colspan="1"  style="width: 176.703125px;">User</th>
	
	<th rowspan="1" colspan="1"  style="width: 118.078125px;">Log Message</th>
...
<?php
	...
	$result = runQuery("SELECT * FROM processlog ORDER BY logtime DESC LIMIT 200");
	$k=1;
